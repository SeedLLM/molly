...
class JsonlDatasetInspector:
    ...
    def count_tasks(
        self, visualize: bool = True, save_path: str = "task_distribution_pie.png"
    ) -> Dict[str, int]:
        """
    ...
    def visualize_per_task(
        self, num_samples_per_task: int = 3
    ) -> Dict[str, List[dict]]:
        """
    ...
    def extract_n_samples_per_task(
        self, n: int, output_file: str, random_seed: int = 42, shuffle: bool = True
    ) -> Dict[str, List[dict]]:
        """
...
if __name__ == "__main__":
    ...
    inspector.extract_n_samples_per_task(
        500, output_file="balanced_dna_train_dataset.jsonl"
    )
